...
## v0.6 — 2026-07-25
DSLO v0.6 is the first public-layer release of the Semantic Substrate
Specification. This version defines the unified geometry governing meaning
invariants, operator legality, drift dynamics, synthetic-pressure fields,
institutional deformation, dominant synthetic species, restorative-deficit
dynamics, and the human runtime manifold (HRM). The v0.6 specification
supersedes the internal v0.5 lineage and establishes the canonical substrate
for cross-surface scientific indexing across GitHub, Zenodo, Hugging Face,
and www.tnopsi.com.

No prior public versions exist.

## v0.6 — 2026-07-26
Added
dslo.owl — canonical DSLO ontology using unified namespace:
https://www.tnopsi.com/dslo-glossary#

Full class declarations for all DSLO glossary terms:

Complete v0.5 substrate‑layer vocabulary

Complete v0.6 public‑layer additions

Ontology header with correct IRI and version IRI

Canonical glossary linkage via rdfs:seeAlso → https://www.tnopsi.com/dslo-glossary

Stable RDF/XML structure suitable for downstream conversion (TTL, JSON‑LD, SKOS, OBO, UMLS)

Established
DSLO ontology as the authoritative machine‑readable semantic surface

Public‑layer substrate vocabulary for AI crawlers, BioPortal ingestion, and semantic‑web indexing
